...
function autocomplete(input, latInput, lngInput) {
  ...
  dropdown.addListener('place_changed', function () {
    ...
    console.log(place);
    latInput.value = place.gemometry.location.lat();
    lngInput.value = place.gemometry.location.lng();
...
/* harmony import */ var _bling__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bling */ "./public/javascripts/modules/bling.js");
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/stores/near?lat=".concat(lat, "&lng=").concat(lng)).then(function (res) {
    ...
    var markers = places.map(function (place) {
      var _place$location$coord = _slicedToArray(place.location.coordinates, 2),
          ...
          placeLat = _place$location$coord[1]; //console.log(placeLng, placeLat);
...
function makeMap(mapDiv) {
  ...
  loadPlaces(map);
  var input = (0,_bling__WEBPACK_IMPORTED_MODULE_2__.$)('[name="geolocate"]');
...
heartForms.on('submit', _modules_heart__WEBPACK_IMPORTED_MODULE_5__["default"]); // you can loop over with bling js ,on() without a forEach-fn
}();
/******/ })()
;
